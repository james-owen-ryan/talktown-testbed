    ...
    def __init__(self):
        ...
        self.initial_job_vacancies = {
            ApartmentComplex: {
                'day': (Landlord,),
                'night': (Janitor,),
                'additional day': [Secretary, Janitor],
                'additional night': [],
            },
            Bank: {
                'day': (BankTeller,),
                'night': (Janitor,),
                'additional day': [BankTeller, BankTeller, Manager],
                'additional night': [],
            },
            Bar: {
                'day': (Bartender,),
            ...
            FireStation: {
                'day': (Firefighter,),
                'night': (Firefighter,),
                'additional day': [FireChief, Secretary],
                'additional night': [Firefighter],
            },
            Hospital: {
                'day': (Secretary, Nurse, Doctor),
                'night': (Nurse, Doctor, Janitor),
                'additional day': [Nurse],
                'additional night': [Secretary, Nurse],
            },
            Hotel: {
                'day': (HotelMaid, Concierge),
                'night': (Concierge,),
                'additional day': [Manager, HotelMaid],
                'additional night': [],
            },
            LawFirm: {
                'day': (Secretary,),
            ...
            PoliceStation: {
                'day': (PoliceOfficer,),
                'night': (PoliceOfficer,),
                'additional day': [Secretary, PoliceChief],
            ...
            TaxiDepot: {
                ...
                'night': (TaxiDriver,),
                'additional day': [],
                'additional night': [TaxiDriver, Manager],
            },
            University: {
                'day': (Professor, Professor),
                'night': (Janitor,),
                'additional day': [Professor],
                'additional night': [Professor],
            },
            Cemetery: {
                'day': (),
                'night': (Groundskeeper,),
                'additional day': [Mortician],
                'additional night': [],
            },
            Park: {
                'day': (Groundskeeper,),
                'night': (),
                'additional day': [Groundskeeper, Manager],
                'additional night': [],
            },
            ...
            Brewery: {
                ...
                'night': (),
                'additional day': [Brewer, Bottler, Bottler, Cooper],
                'additional night': [Janitor],
            },
            ButcherShop: {
                'day': (),
            ...
            Distillery: {
                ...
                'night': (),
                'additional day': [Bottler, Bottler, Cooper],
                'additional night': [Janitor],
            },
            DrugStore: {
                'day': (),
